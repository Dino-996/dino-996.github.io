...
export default async function () {
    ...
    console.log("--- TEST ---");
    console.log("Cartella attuale (CWD):", process.cwd());
    console.log("Percorso cercato per .env:", path.resolve(process.cwd(), '.env'));
    console.log("Valore STRAPI_TOKEN:", STRAPI_TOKEN ? "TROVATO" : "NON TROVATO");
    console.log("-------------------------");
    ...
    try {
        ...
        console.log("Esempio primo post ricevuto:", JSON.stringify(data[0], null, 2));
